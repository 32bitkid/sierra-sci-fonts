...
fonts: dist-folders
	...
	$(SCIOTF_BIN) advanced ./defs/font.001.json      -f otf -f woff2 -a 1:1.2 -c inside -s none -o dist --verbose > ./dist/sciAC-font-001.md
	$(SCIOTF_BIN) advanced ./defs/font.001.free.json -f otf -f woff2 -a 1:1   -c none   -s none -o dist --verbose > ./dist/sciPX-font-001-free.md
	$(SCIOTF_BIN) advanced ./defs/font.001.json      -f otf -f woff2 -a 1:1   -c none   -s none -o dist --verbose > ./dist/sciPX-font-001.md
...
update-font-001-def:
	...
	" ./defs/font.001.json > "$$TMPFILE" && \
	cp $$TMPFILE ./defs/font.001.json
...
specimen: dist-folders rebuild-specimen
	...
	./specimen/dist/index.mjs ./dist/sciAC-font-001.otf > ./dist/sciAC-font-001.png
	...
	./specimen/dist/index.mjs ./dist/sciPX-font-001.otf > ./dist/sciPX-font-001.png
